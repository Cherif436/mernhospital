  ...
  return (
    <div>
        ...
        <div className="flex items-center justify-center min-h-screen rounded-md">
          <div className="w-[15400px] grid grid-cols-1 shadow-xl py-4 md:grid-cols-2">
            <div className="py-12">
              ...
              <p className="px-2 py-8 font-light text-center cursor-pointer text-light">
            ...
            <div className="grid items-center justify-around grid-cols-2 gap-4 px-3 py-4">
      ...
      <div className="text-center text-md">
        <button className="py-4 text-center text-blue-600 underline  underline-offset-8">

        ...
        <table className="min-w-[1540px] mx-auto bg-white shadow-md rounded-lg">
          <thead className="p-2 text-white bg-gray-800">
            <tr className="py-2">
              ...
              <th className="px-4 py-2 text-lg cursor-pointer">Email</th>
            ...
            {doctors && doctors.length > 0 ? (
              doctors.map((ele, index) => (
                <tr key={ele._id} className="hover:bg-gray-300 ">
                  ...
                  <td className="px-4 py-2 text-center cursor-pointer">{`${ele.firstName} ${ele.lastName}`}</td>
                  <td className="px-4 py-2 text-center cursor-pointer">
                    {ele.email}
                  </td>
                  <td className="px-4 py-2 text-center cursor-pointer">
                  ...
                  <td>
                    <MdDelete
                      ...
                      className="mx-auto text-3xl text-red-600 cursor-pointer"
                    />
                  </td>
                </tr>
              ))
